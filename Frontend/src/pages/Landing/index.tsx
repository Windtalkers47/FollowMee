  ...
  return <Box component="main" minHeight="100svh" sx={{ bgcolor: 'background.default', py: { xs: 3, md: 7 } }}>
    <Container maxWidth="lg">
      ...
      <Stack direction={{ xs: 'column', md: 'row' }} spacing={{ xs: 5, md: 9 }} alignItems="center">
        ...
        <Box component={RouterLink} to="/demo/profile" aria-label={t('landing.openPreviewCard')} sx={{ width: { xs: '100%', md: 420 }, maxHeight: 560, overflow: 'hidden', borderRadius: 6, textDecoration: 'none', boxShadow: '0 28px 70px rgba(31,25,34,.15)', transition: 'transform 180ms ease', '&:hover': { transform: 'translateY(-4px)' } }}>
