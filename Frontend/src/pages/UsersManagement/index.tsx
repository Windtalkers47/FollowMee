...
const UsersPage = () => {
  ...
  const [invitations, setInvitations] = useState<Array<{ invitationId: number; email: string; roleName?: string; status: 'pending' | 'accepted' | 'expired' | 'revoked'; expiresAt: string; createdAt: string }>>([]);
